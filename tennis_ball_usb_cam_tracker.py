...
def image_callback(image_frame):
    print 'got an image'
    global bridge
    #convert image_frame which is a ros image into an opencv-compatible image
    try:
        cv_image = bridge.imgmsg_to_cv2(image_frame, "bgr8")
...
def main():
  ...
  print 'usb cam tracker is running'
  try:
    rospy.spin()
